...
function reducer(
  state: RegistrationBody,
  action: { type: keys; payload: string }
) {
  const newState = {
    ...state,
  };
...
export function Page() {
  ...
  const [registratinFormState, registratinFormDispatch] = useReducer(
    reducer,
      ...
      return (
        <Fragment>
          <div>
            ...
            <Input
              autofocus={true}
              value={registratinFormState.name}
              key={'1'}
              inputChange={(value) =>
                registratinFormDispatch({ type: 'name', payload: value })
              }
            />
          </div>
          ...
          <div className={'mt-24'}>
            ...
            <Input
              value={registratinFormState.fullName}
              inputChange={(value) =>
                registratinFormDispatch({ type: 'fullName', payload: value })
              }
            />
          </div>
          ...
          <div className={'mt-24'}>
            ...
            <Input
              value={registratinFormState.email}
              inputChange={(value) =>
                registratinFormDispatch({ type: 'email', payload: value })
              }
            />
          </div>
          ...
          <div className={'mt-24'}>
            ...
            <Input
              value={registratinFormState.phone}
              inputChange={(value) =>
                registratinFormDispatch({ type: 'phone', payload: value })
              }
            />
          </div>
          ...
          <div className={'mt-24'}>
            ...
            <Input
              value={registratinFormState.dateIssue}
              inputChange={(value) =>
                registratinFormDispatch({ type: 'dateIssue', payload: value })
              }
            />
          </div>
        </Fragment>
